...
**(recommended)** PDF reader = Zathura. xreader and evince are also supported when loading generated pdfs through the Sublime Text 3 macro, but Zathura is the prefered pdf viewer--especially when running either i3 or swaywm, as it will then load the pdf on the 2nd workspace.
